...
namespace App\Http\Livewire\Tenant\Charges\Proposal;
...
//            $this->franchising = $franchisingReturnDB;
    ...
    public function getSelectTemplatesProposals()
    {
        ...
        return $templateProposalRepository->getSelectTemplateProposal('Cobrança')['data'];
    }
    ...
    public function save()
    {
        ...
        $feesRepository = new ProposalRepository();
    ...
    public function render()
    {
        ...
        return view('livewire.tenant.charges.proposal.form', ['response' => $response]);
    }
}
