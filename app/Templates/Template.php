...
namespace App\Templates;
    ...
    /**
     * Templates Management for PHP5
     *
     * The Templates engine allows to keep the HTML code in some external files
    ...
    class Template {
        ...
        /**
         * Describes the replace method for blocks. See the Templates::setFile()
         ...
         * variable's value.
         * Additionally, this method call Templates::identify() that identifies
        ...
        protected function loadfile($varname, $filename) {
            ...
            if($this->isPHP($filename)){
                ...
                $str = preg_replace("/<!---.*?--->/smi", "", file_get_contents($filename, true));
                dd($str);
         ...
         * user calls Templates::setFile(). This method calls Templates::identifyVars()
         * and Templates::identifyBlocks() methods to do the job.
         *
        ...
        /**
         * Create all identified blocks given by Templates::identifyBlocks().
         *
         ...
         *
         * The main difference between this and Templates::__set() method is this
...
//
//    /**
//     * Suitable for Templates class: similar to str_replace, but using string in first param
//     * @see str_replace
//     * @param string $str
//     * @param string $search
