...
<head>
    ...
    <title>Proposta de Quitação de Divida</title>
...
<div class="h-screen pb-14 bg-right bg-cover" style="background-image:{{URL::asset('/proposal/bg.svg')}};">
   <!--Nav-->
    <div class="w-full container mx-auto p-6">

        <div class="w-full flex items-center justify-between">
            <a class="flex items-center text-indigo-400 no-underline hover:no-underline font-bold text-2xl lg:text-4xl"  href="#">
                <img src="https://blog.odontocompany.com/wp-content/uploads/2020/07/Logo-974x310px-1.png" class="h-16" alt="odontocompany" />
            </a>

            <div class="flex w-1/2 justify-end content-center">
                <a class="inline-block text-green-500 no-underline hover:text-green-800 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4" data-tippy-content="@twitter_handle" href="https://twitter.com/intent/tweet?url=#">
                ...
                <a class="inline-block text-green-500 no-underline hover:text-green-800 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 " data-tippy-content="#facebook_id" href="https://www.facebook.com/sharer/sharer.php?u=#">
    ...
    <!--Main-->
    <div class="container pt-24 md:pt-26 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
...
{{--            <img class="w-5/6 mx-auto lg:mr-0 slide-in-bottom" src="{{URL::asset('/proposal/devices.svg')}}">--}}
            <img class="w-5/6 mx-auto lg:mr-0 slide-in-bottom rounded-xl" src="https://odontocompanybrazlandia.com.br/assets/img/clinica01.jpg">
        </div>
