<footer class="text-center lg:text-left bg-gray-100 text-gray-600">
    ...
    <div class="mx-6 py-10 text-center md:text-left">
      ...
      ">
                ...
                <p>
                    Plataforma Inteligente de cobrança de franqueados !
                </p>
            </div>
            <div class="">
            ...
            <div class="">
                ...
                <p class="mb-4">
                    <a href="#!" class="text-gray-600">Preços</a>
                </p>
                <p class="mb-4">
                    <a href="#!" class="text-gray-600">Configurações</a>
                </p>
                <p class="mb-4">
                    <a href="#!" class="text-gray-600">Usabilidade</a>
                </p>
                <p>
                    <a href="#!" class="text-gray-600">Ajuda</a>
                </p>
            </div>
            <div class="">
                <h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start">
    ...
    <div class="text-center p-6 primary-color ">
        <span class="text-white primary-text-color" >© 2023 Copyright:</span>
        <a class="text-white primary-text-color font-semibold" href="#">Cany</a>
    </div>
</footer>
