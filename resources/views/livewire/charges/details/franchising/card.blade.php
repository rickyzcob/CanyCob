<div>
    <x-card cardClasses="h-52 border-l-4 border-orange-400">
        <div class="flex items-start justify-between border-b-2 mb-2">
            ...
            <x-button.circle wire:click="openModal('franchising.form', {'id': {{$franchising['id']}} })" sm warning icon="pencil-alt" />
                @endcan
            @endif
        </div>
