...
{{--            <x-button wire:click="openModal('charges.proposal.form', {'id': {{$charge['id']}} })" teal sm icon="information-circle" label="Alterar Status"/>--}}
            <div>
                ...
                <x-button wire:click="openModal('charges.agreement.form', {'id': {{$response->charge['id']}} })" green sm icon="document-report" label="Gerar Acordo"/>
                @endif
