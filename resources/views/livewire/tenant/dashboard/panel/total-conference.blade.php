<div>
    <div class="md:col-span-3">
        <div class="relative px-3 rounded shadow-lg max-w-sm h-full bg-yellow-500">
            <div class="flex justify-between items-center">
                <div class="text-white">
                    <h6 class="uppercase font-semibold text-white">A Conferir</h6>
                    <h3 class="text-2xl font-semibold mt-0">{{ $response->amount_conference }}</h3>
                    <div class="">
