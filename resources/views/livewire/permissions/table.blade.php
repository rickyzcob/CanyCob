            ...
            <tr>
                ...
                <td width="150px">
                    <div class="flex flex-wrap justify-items-center gap-x-2">
                        ...
                        <x-button.circle wire:click="openModal('permissions.roles', {'id': {{ $itemRole['id'] }} } )"  positive icon="archive" />
                        @endcan
                        @can('edit_permission')
                        <x-button.circle wire:click="openModal('permissions.form', {'id': {{ $itemRole['id'] }} } )" warning icon="pencil-alt" />
                        @endcan
