<div>
    <x-card>
        <div class="flex items-start justify-between border-b-2 mb-2 py-2">
            ...
            <x-button wire:click="openModal('franchising.contacts.form', {'franchising_id': {{$franchising['id']}} }, 2)" positive icon="plus-circle" label="Adicionar"/>
        </div>
                ...
                <tr>
                    ...
                    <td width="110px">
                        <div class="flex flex-wrap justify-items-center gap-x-2">
                            <x-button sm warning icon="pencil-alt" wire:click="openModal('franchising.contacts.form', {'id': {{$itemContact['id']}} }, 2)" />
