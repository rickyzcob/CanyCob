            ...
            <tr>
                ...
                <td width="250px">
                    <div class="flex flex-wrap justify-items-center gap-x-2">
                        ...
                        <x-button sm blue icon="user-circle" primary wire:click="openModal('franchising.partners.table', {'id': {{ $itemPaymentFranchising['id'] }} } )"/>
                        <x-button sm orange icon="user" primary wire:click="openModal('franchising.contacts.table', {'id': {{ $itemPaymentFranchising['id'] }} } )"/>
                        <x-button sm warning icon="pencil-alt" wire:click="openModal('franchising.form', {'id': {{ $itemPaymentFranchising['id'] }} } )" />
