...
{{--            <div class="w-full">--}}
    ...
    <div
{{--      class="absolute transform transition duration-200 top-0 right-0 z-10 w-1/3 bg-white text-gray-500 h-screen p-4"--}}
      class="absolute md:w-auto md:h-auto md:bg-opacity-0   z-10 text-gray-500 w-full h-full overflow-y-auto bg-white p-4"
      x-show="isOpen"
      x-cloak
