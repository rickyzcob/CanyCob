...
class Input extends FormComponent
{
    ...
    protected function getDefaultColorClasses(): string
    {
        return Str::of('placeholder-secondary-400 dark:bg-secondary-800 dark:text-secondary-400')
            ...
            ->unless($this->borderless, function (Stringable $stringable) {
                return $stringable
                    ->append(' border border-secondary-300 ')
    ...
    {
        return Str::of('block w-full sm:text-sm rounded-tr-full rounded-br-full rounded-bl-full transition ease-in-out duration-100 focus:outline-none')
